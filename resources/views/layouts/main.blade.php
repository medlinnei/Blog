...
<header class="edica-header">
    <div class="container">
        <nav class="navbar navbar-expand-lg navbar-light">
            <a class="navbar-brand" href="index.html"><img src="{{url('assets/images/logo.svg')}}" alt="Edica"></a>
            ...
            <div class="collapse navbar-collapse" id="edicaMainNav">
                <ul class="navbar-nav mx-auto mt-2 mt-lg-0">
                    ...
                    <li class="nav-item active">
                        ...
                        @endauth
                        @guest()
                            <a class="nav-link" href="{{route('personal.main.index')}}">Вхід<span class="sr-only">(current)</span></a>
                        @endguest
                    </li>
                </ul>
            </div>
